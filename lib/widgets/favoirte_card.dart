...
class FavoirteCard extends StatefulWidget {
  FavoirteCard({Key? key, required this.index, required this.items})
      : super(key: key);

  List<Item> items;
  int index;
  @override
  _FavoirteCardState createState() => _FavoirteCardState();
}

class _FavoirteCardState extends State<FavoirteCard> {
  @override
